...
if not os.path.isfile(settings_file):
    ...
    courses_url = website + courses_api + '?access_token=' + course_to_folder['ACCESS_TOKEN__']
    ...
    course_to_folder['directory__'] = raw_input('Enter the directory relative to ~ (start with /): ')
...
for course in courses:
    ...
    if course['name'] not in course_to_folder:
        continue
